...
#include "CoopGamePrototype/SGameState.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	COOPGAMEPROTOTYPE_API UEnum* Z_Construct_UEnum_CoopGamePrototype_EWaveState();
	UPackage* Z_Construct_UPackage__Script_CoopGamePrototype();
	COOPGAMEPROTOTYPE_API UClass* Z_Construct_UClass_ASGameState_NoRegister();
	COOPGAMEPROTOTYPE_API UClass* Z_Construct_UClass_ASGameState();
	ENGINE_API UClass* Z_Construct_UClass_AGameStateBase();
	COOPGAMEPROTOTYPE_API UFunction* Z_Construct_UFunction_ASGameState_OnRep_WaveState();
	COOPGAMEPROTOTYPE_API UFunction* Z_Construct_UFunction_ASGameState_WaveStateChanged();
// End Cross Module References
	static UEnum* EWaveState_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_CoopGamePrototype_EWaveState, Z_Construct_UPackage__Script_CoopGamePrototype(), TEXT("EWaveState"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EWaveState(EWaveState_StaticEnum, TEXT("/Script/CoopGamePrototype"), TEXT("EWaveState"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_CoopGamePrototype_EWaveState_Hash() { return 3281432901U; }
	UEnum* Z_Construct_UEnum_CoopGamePrototype_EWaveState()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_CoopGamePrototype();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EWaveState"), 0, Get_Z_Construct_UEnum_CoopGamePrototype_EWaveState_Hash(), false);
#else
	...
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ASGameState_OnRep_WaveState_Statics::NewProp_oldState = { "oldState", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SGameState_eventOnRep_WaveState_Parms, oldState), Z_Construct_UEnum_CoopGamePrototype_EWaveState, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASGameState_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASGameState_OnRep_WaveState, "OnRep_WaveState" }, // 2733400836
		{ &Z_Construct_UFunction_ASGameState_WaveStateChanged, "WaveStateChanged" }, // 1735840144
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ASGameState_Statics::NewProp_WaveState = { "WaveState", "OnRep_WaveState", (EPropertyFlags)0x0020080100000034, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASGameState, WaveState), Z_Construct_UEnum_CoopGamePrototype_EWaveState, METADATA_PARAMS(Z_Construct_UClass_ASGameState_Statics::NewProp_WaveState_MetaData, ARRAY_COUNT(Z_Construct_UClass_ASGameState_Statics::NewProp_WaveState_MetaData)) };
	...
	IMPLEMENT_CLASS(ASGameState, 3822325863);
	template<> COOPGAMEPROTOTYPE_API UClass* StaticClass<ASGameState>()
	{
		return ASGameState::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASGameState(Z_Construct_UClass_ASGameState, &ASGameState::StaticClass, TEXT("/Script/CoopGamePrototype"), TEXT("ASGameState"), false, nullptr, nullptr, nullptr);
