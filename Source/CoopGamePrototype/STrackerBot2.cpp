...
static int32 DebugTrackerBot2Drawing = 0;
FAutoConsoleVariableRef CVARDebugTrackerBot2Drawing(
	TEXT("COOP.DebugTrackerBot2"),
	DebugTrackerBot2Drawing,
	TEXT("Draw Debug Lines for TrackerBot2"),
	ECVF_Cheat);


// Sets default values
ASTrackerBot2::ASTrackerBot2()
{
	...
	HealthComp->OnHealthChanged.AddDynamic(this, &ASTrackerBot2::HandleTakeDamage);
	...
	MeshComp->SetCanEverAffectNavigation(false);//able to move in the nav mesh
	MeshComp->SetSimulatePhysics(true); //allow the object to have a physical body
...
void ASTrackerBot2::BeginPlay()
{
	...
	if (Role == ROLE_Authority)
	{
		...
		GetWorldTimerManager().SetTimer(TimerHandle_CheckPowerLevel, this, &ASTrackerBot2::OnCheckNearbyBots, 1.0f, true);
	}
}

void ASTrackerBot2::HandleTakeDamage(USHealthComponent * OwningHealthComp, float Health, float HealthDelta, const UDamageType * DamageType, AController * InstigatedBy, AActor * DamageCauser)
{
...
FVector ASTrackerBot2::GetNextPathPoint()
{
	...
	if (BestTarget)
	{
		...
		GetWorldTimerManager().SetTimer(TimerHandle_RefreshPath, this, &ASTrackerBot2::RefreshPath, 5.0f, false);
...
void ASTrackerBot2::SelfDestruct()
{
	if (bExploded)
	{
		return;
...
void ASTrackerBot2::DamageSelf()
{
	UGameplayStatics::ApplyDamage(this, 20, GetInstigatorController(), this, nullptr);
}

// Called every frame
void ASTrackerBot2::Tick(float DeltaTime)
{
...
void ASTrackerBot2::NotifyActorBeginOverlap(AActor * OtherActor)
{
	...
	if (!bStartedSelfDestruction) {
		...
		if (PlayerPawn && !USHealthComponent::IsFriendly(OtherActor,this)) {
			...
			GetWorldTimerManager().SetTimer(TimerHandle_SelfDamage, this, &ASTrackerBot2::DamageSelf, .5f, true, 0.f);
...
void ASTrackerBot2::OnCheckNearbyBots()
{
	...
	for (FOverlapResult Result : Overlaps)
	{
		...
		ASTrackerBot2* Bot = Cast<ASTrackerBot2>(Result.GetActor());
...
void ASTrackerBot2::RefreshPath()
{
	NextPathPoint = GetNextPathPoint();
}